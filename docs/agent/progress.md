...
**进行中**：ME4-4.3.1（推理黑盒验收 J14/J19 + 探针 4b）PR #512 已开（分支 `feat/me4-4.3.1-model-blackbox`），Opus 本地评审 2 轮（CHANGES → APPROVE，Medium 全修），Codex 未审，计入 `ME4-CODEX-DEBT-7`；待外部评审服务裁决。
